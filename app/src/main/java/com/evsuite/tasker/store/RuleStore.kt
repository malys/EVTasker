 ...
 * (Same reasoning as ProfileManager in EVProfile.)
 */
class RuleStore(context: Context) {

    companion object {
        private const val TAG = "EV_RULE_STORE"
        private const val PREFS = "ev_tasker_rules"
     ...
     * or repaired, and letting it through hands a null [com.evsuite.hardware.catalog.ConditionType]
