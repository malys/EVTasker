...
import com.evsuite.tasker.databinding.FragmentConsoleBinding
...
class ConsoleFragment : Fragment() {
    ...
    private fun export() {
        StorageBrowserDialog.pickFolder(requireContext(), R.string.rules_export_pick) { dir ->
            ...
            // The probe binds to EVProfile and reads system properties: never on the main thread.
    ...
    private companion object {
        const val SHARE_TAG = "EVTasker.Share"
    }
}
