...
import com.evsuite.tasker.databinding.ActivityRuleEditorBinding
import com.evsuite.tasker.databinding.ItemBranchRowBinding
        ...
        if (rule.totalDelayMs > com.evsuite.tasker.model.DELAY_BUDGET_MS) {
            toastLong(
                getString(
                    ...
                    (com.evsuite.tasker.model.DELAY_BUDGET_MS / 1000).toInt()
                )
            )
            return
        }
