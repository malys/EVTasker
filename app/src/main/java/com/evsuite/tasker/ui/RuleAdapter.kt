...
import com.evsuite.tasker.databinding.ItemRuleBinding
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.binding.ruleSummary.text = if (rule.hasAlternatives) {
            ...
            context.resources.getQuantityString(
                com.evsuite.tasker.R.plurals.rule_summary_cases, cases, cases
            )
        } else {
            context.resources.getQuantityString(
                com.evsuite.tasker.R.plurals.rule_summary_conditions, rule.conditions.size, rule.conditions.size
            ) + " → " + context.resources.getQuantityString(
                com.evsuite.tasker.R.plurals.rule_summary_actions, rule.actions.size, rule.actions.size
            )
        }
